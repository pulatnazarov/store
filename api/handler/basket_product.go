...
func (h Handler) CreateBasketProduct(c *gin.Context) {
	...
	if err != nil {
		handleResponse(c, h.log, "error is while creating basket product", http.StatusInternalServerError, err)
		return
	}

	handleResponse(c, h.log, "", http.StatusCreated, createdBasketProduct)
}
...
func (h Handler) GetBasketProductList(c *gin.Context) {
	...
	if bID != "" {
		...
		if err != nil {
			handleResponse(c, h.log, "error in basket id", http.StatusBadRequest, err.Error())
			return
		}
...
func (h Handler) UpdateBasketProduct(c *gin.Context) {
	...
	if err != nil {
		handleResponse(c, h.log, "error is while updating basket", http.StatusInternalServerError, err.Error())
		return
	}
...
func (h Handler) DeleteBasketProduct(c *gin.Context) {
	...
	handleResponse(c, h.log, "", http.StatusOK, "basket product deleted!")
}
