...
func (h Handler) ProductReportList(c *gin.Context) {
	...
	productReport, err := h.services.Report().ProductReportList(context.Background(), models.ReportRequest{
		Page:     page,
		Limit:    limit,
		BranchID: branchID,
		From:     from,
...
// @Router       /income-product/report [GET]
...
func (h Handler) IncomeProductReport(c *gin.Context) {
	...
	incomeProductReport, err := h.services.Report().IncomeProductList(context.Background(), models.ReportRequest{
		Page:     page,
		Limit:    limit,
		BranchID: branchID,
		From:     from,
